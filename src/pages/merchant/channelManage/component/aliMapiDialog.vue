 ...
 * @LastEditors: 张淦
 * @Description: 商户系统 - 渠道账号管理 - 支付宝收款账号管理 - mapi秘钥弹框
 * @FilePath: /gpay-ops-static/src/pages/merchant/channelManage/component/aliMapiDialog.vue
 -->
<template>
  <v-dialog
    title="mapi秘钥"
    ...
    this.submitFormArr = [
      {
        ...
        message: "新增mapi网关产品秘钥",
      },
      {
        url: "/pay/config/modify.json",
        message: "修改mapi网关产品秘钥",
      },
    ];
    return {
